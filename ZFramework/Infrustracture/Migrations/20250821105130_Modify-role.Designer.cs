            ...
            modelBuilder.Entity("Domain.Entites.RolePermission", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 21, 14, 21, 30, 421, DateTimeKind.Local).AddTicks(210));
            ...
            modelBuilder.Entity("Domain.Entites.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 21, 14, 21, 30, 420, DateTimeKind.Local).AddTicks(8298));
            ...
            modelBuilder.Entity("Domain.Entites.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 21, 14, 21, 30, 420, DateTimeKind.Local).AddTicks(9350));
