            ...
            modelBuilder.Entity("Domain.Entites.Permission", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDareTime")
                        .HasColumnType("datetime2");

                    b.Property<bool>("IsActivee")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("ModifyDateTimd")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entites.RolePermission", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 17, 23, 9, 26, 850, DateTimeKind.Local).AddTicks(5938));
            ...
            modelBuilder.Entity("Domain.Entites.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 17, 23, 9, 26, 850, DateTimeKind.Local).AddTicks(4069));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertBy = 0,
                            InsertDate = new DateTime(2025, 8, 17, 23, 9, 27, 82, DateTimeKind.Local).AddTicks(6096),
                            IsDeleted = false,
                            LastName = "Zarrabi",
            ...
            modelBuilder.Entity("Domain.Entites.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 17, 23, 9, 26, 850, DateTimeKind.Local).AddTicks(5540));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            InsertBy = 0,
                            InsertDate = new DateTime(2025, 8, 17, 23, 9, 27, 82, DateTimeKind.Local).AddTicks(7429),
                            IsDeleted = false,
                            RoleId = 1,
                            UserId = 1
                        });
